				...
				<div className="mx-auto w-full max-w-7xl px-8">
								...
								<ul className="space-y-1">
									{links.map((link, key) => (
										<Typography
											...
											children={
												<p className="inline-block py-1 pr-2 transition-transform hover:scale-105">
													{link}
												</p>
											}
											placeholder={undefined}
					...
					<div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
						<div className=" flex gap-2 mb-2 md:mb-0 items-center justify-center lg:gap-2">
							<Link to={"/"} className=" !text-green-600 text-lg">
								Ride
							</Link>
							<Typography
								variant="small"
								className="shrink-0 text-center font-normal text-blue-gray-900 mb-0"
								children={`&copy; ${currentYear}. All Rights Reserved.`}
								placeholder={undefined}
								onPointerEnterCapture={undefined}
								onPointerLeaveCapture={undefined}
							>
